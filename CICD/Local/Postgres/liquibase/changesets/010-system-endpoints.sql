...
--changeset akg:010-system-endpoints splitStatements:false endDelimiter:\n/
...
-- Rows are NOT inserted here (see 012). The system endpoints load through
-- Administration -> Initial Data like everything else.
