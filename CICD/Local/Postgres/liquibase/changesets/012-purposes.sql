...
--changeset akg:012-purposes splitStatements:false endDelimiter:\n/
--comment purposes
--rollback empty
...
-- Rows are NOT inserted here. Schema only: every row arrives through
-- Administration -> Initial Data, so a fresh database is genuinely empty and an
-- administrator can see what loading actually did.
