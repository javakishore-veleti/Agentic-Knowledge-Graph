...
import { CATALOG_BASE_URL, DATA_MGMT_BASE_URL, CatalogApi, HttpCatalogApi, MockCatalogApi } from './core/catalog-api';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    { provide: DATA_MGMT_BASE_URL, useValue: environment.dataMgmtBaseUrl },
